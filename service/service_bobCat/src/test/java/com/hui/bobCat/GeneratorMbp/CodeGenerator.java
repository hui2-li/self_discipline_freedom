...
public class CodeGenerator {
    ...
    public void run(){
        ...
        gc.setOutputDir("C:\\Users\\hui\\Desktop\\新建文件夹 (2)"+ "/src/main/java");
        gc.setAuthor("lihui");
        //gc.set
        ...
        dsc.setUrl("jdbc:oracle:thin:@10.132.118.151:1521:mesdb");
        dsc.setDriverName("oracle.jdbc.OracleDriver");
        dsc.setUsername("mes_trace");
        dsc.setPassword("Trace$9dec");
         ...
         */
        strategy.setInclude(new String[]{"MES.SYS_MEASURE"});
