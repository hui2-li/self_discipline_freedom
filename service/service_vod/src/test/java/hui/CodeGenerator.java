...
public class CodeGenerator {
    ...
    public void run(){
        ...
        //此处最好用绝对路径
        gc.setOutputDir("C:\\D\\soft\\workspace\\self_discipline_freedom\\service\\service_vod" + "/src/main/java");
        ...
        dsc.setUrl("jdbc:oracle:thin:@10.162.244.166:1521:tracedb");
        ...
        strategy.setInclude(new String[]{"OEE_XY_ALARM"}); //区分大小写（注意）oracle一般是大写
